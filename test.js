...
QUnit.test("Atomix base classes", function( assert ){
    ...
    assert.strictEqual( proton._type_, "base",     "Proton is a base class" );
});
...
QUnit.test("Atomix.class", function( assert ) {
    ...
    assert.strictEqual( hello._type_, "class",   'type of s1 is "class"' );
    assert.strictEqual( hello._ns_, Salutations, 'Hello was exported to namespace "Salutations"' );
});
...
QUnit.test("Atomix.singleton", function( assert ) {
    ...
    assert.strictEqual( s1._type_, "singleton", 'type of s1 is "singleton"');
    assert.strictEqual( s1 , s2,                "s1 is equal to s2");
    assert.strictEqual( s1._ns_, Atomix.lib,    "s1 has been exported to default namespace" );
    ...
    assert.strictEqual( yo._type_, "singleton", 'type of yo is "singleton"');
    ...
    assert.strictEqual( hola1._type_,"singleton",'type of hola1 is "singleton"' );
